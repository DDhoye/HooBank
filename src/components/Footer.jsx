...
const Footer = () => (
   <section className={`${styles.flexCenter} ${styles.paddingY} flex-col`}>
          ...
          <div key={footerlink.key} className='flex flex-col ss:my-0 my-4 min-w-[150px]'>
            ...
            <ul className='list-none mt-4'>
              {footerlink.links.map((link, index) => (             
                ...
                text-dimWhite hover:text-secondary cursor-pointer ${index !==
    ...
    <div className='w-full flex justify-between items-center md:flex-row flex-col
      ...
      <p className='font-poppins  text-white text-center font-normal  
              text-[18px] leading-[27px]'>2023 HooBank. All Rights Reserved
      </p>
      ...
      <div className='flex flex-row md:mt-0 mt-6'>
        {socialMedia.map((social, index) => (
          ...
          src={social.icon}
          alt={social.id}
          className={` object-contain cursor-pointer ${index
